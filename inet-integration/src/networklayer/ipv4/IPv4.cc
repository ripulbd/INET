...
void IPv4::handleIncomingDatagram(IPv4Datagram *datagram, const InterfaceEntry *fromIE)
{
    ...
    EV << "Received datagram `" << datagram->getName() << "' with src=" << datagram->getSourceAddress() << "\n";
...
{
    EV << "Are we here? Source Address:" << datagram->getSrcAddress() << ", Dest Address:" << datagram->getDestAddress()<<"\n";
