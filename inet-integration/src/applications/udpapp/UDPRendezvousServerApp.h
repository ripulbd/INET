 ...
 */
class INET_API UDPRendezvousServerApp : public ApplicationBase
{
  protected:
    ...
    UDPRendezvousServerTable serverTable;
    ...
    virtual void processRegistrationPacket(cMessage *msg);
    virtual void setSocketOptions();

  public:
    UDPRendezvousServerApp();
    ~UDPRendezvousServerApp();
